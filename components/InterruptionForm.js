...
import { db } from '../screens/qualite/config';
import DateTime from '../screens/qualite/DateTime';
import { SelectList } from 'react-native-dropdown-select-list';

export default function InterruptionForm({ route }) {
    ...
    const HandleSubmit = ()=>{
        if(validateForm()){
                ...
                console.log('data submited', docRef.id)
            }).catch((error)=>{
                console.log(error)
            })
    ...
    return (
        <ScrollView style={styles.container}>
            <Text style={styles.titleForm}> Bon N° xxx</Text>
            ...
            <View style={styles.field}>
                ...
                <TextInput style={[styles.inputField]} value={troncon} onChangeText={setTroncon} />
